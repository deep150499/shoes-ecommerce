        ...
        <div className="w-full bg-gray-50 rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6" action="#">
                    ...
                    <div>
                        <label for="password" className="block mb-2 text-sm font-medium text-black">Confirm Password</label>
                        <input type="password" name="password" id="password" placeholder="confirm paswword" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " required=""/>
                    </div>
                    <div className="flex items-center justify-between">
                        ...
                        <label for="terms" class="font-light text-black">I accept the <a class="font-medium text-blue-600 hover:underline " href="terms-conditions">Terms and Conditions</a></label>
                      </div>
                        </div>
                    </div>
